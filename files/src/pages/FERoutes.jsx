          ...
          <div style={styles.assignedRouteList}>
            {filteredRows.map((row) => {
              ...
              return (
                ...
                >
                  <div style={styles.assignedRouteMain}>
                    <div>
                      ...
                      <span style={styles.recordSubText}>
                        {getGridMarket(row.grid) || "Unknown Market"}
                      </span>
                    </div>
                  ...
                  <div style={styles.assignedRouteActions}>
                    ...
                    {row.route && (
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => exportRouteKml({ route: row.route, grid: row.grid })}
                        ...
                        <button
                          type="button"
                          onClick={() => exportRouteHtml({ route: row.route, grid: row.grid })}
                          style={styles.exportButton}
                        >
                          HTML
                        </button>
                        ...
                        <button
                          type="button"
                          onClick={() => exportRouteZip({ route: row.route, grid: row.grid })}
                          style={styles.exportButton}
                        >
                          ZIP
                        </button>
