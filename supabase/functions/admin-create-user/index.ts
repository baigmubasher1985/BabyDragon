// F10C1I Phase 2 R1 — undeployed Edge Function entry: admin-create-user

import { createClient } from 'https://esm.sh/@supabase/supabase-js@2.49.1'
import { parseAllowedOrigins } from '../_shared/cors.ts'
import { createDefaultCreateUserDeps, handleAdminCreateUser } from './handler.ts'

Deno.serve(async (req) => {
  const deps = createDefaultCreateUserDeps({
  ...
  return handleAdminCreateUser(req, deps)
})
